 ...
 * --> [TIMER0_OC0_NON_INVERTING_msk]    --> (Clear OC0 on compare match, set OC0 at BOTTOM)
 * --> [TIMER0_OC0_INVERTING_msk]        --> (Set OC0 on compare match, clear OC0 at BOTTOM)
 *
 * */
#define TIMER0_OC0_Behavior_Selector         TIMER0_OC0_TOGGLE_msk
 ...
 *
 * (Fast PWM mode or Phase Correct PWM Mode ):
 * --> [TIMER2_OC2_NON_INVERTING_msk]    --> (Clear OC2 on compare match, set OC2 at BOTTOM)
 * --> [TIMER2_OC2_INVERTING_msk]        --> (Set OC2 on compare match, clear OC2 at BOTTOM)
 *
 */
 ...
 */
#define TIMER1_OC1_Behavior_Selector         TIMER1_OC1_TOGGLE_msk
